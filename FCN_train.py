...
import keras_segmentation as m
m.models.basic_models
...
FLAGS = easydict.EasyDict({"img_size": 512,
                           ...
                           "pre_checkpoint_path": "C:/Users/Yuhwan/Downloads/138/138",
    ...
    if FLAGS.train:
        ...
        for epoch in range(FLAGS.epochs):
            ...
            for step in range(tr_idx):
                ...
                batch_labels = np.where(batch_labels == FLAGS.ignore_label, 2, batch_labels)

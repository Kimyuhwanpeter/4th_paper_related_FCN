...
def resize_image(inp,  s, data_format):
    ...
    try:
        ...
        return tf.keras.layers.Lambda(lambda x: K.resize_images(x,
                                                height_factor=s[0],
                                                width_factor=s[1],
...
def get_segmentation_model(input, output):
    ...
    i_shape = tf.keras.Model(img_input, o).input_shape
    ...
    if IMAGE_ORDERING == 'channels_first':
        ...
        n_classes = o_shape[1]
        o = (tf.keras.layers.Reshape((-1, output_height*output_width)))(o)
        ...
        n_classes = o_shape[3]
        #o = (tf.keras.layers.Reshape((output_height*output_width, -1)))(o)

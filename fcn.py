...
# crop o1 wrt o2
def crop(o1, o2, i):
    o_shape2 = tf.keras.Model(i, o2).output_shape
    ...
    o_shape1 = tf.keras.Model(i, o1).output_shape
    if IMAGE_ORDERING == 'channels_first':
    ...
    if output_width1 > output_width2:
        o1 = tf.keras.layers.Cropping2D(cropping=((0, 0),  (0, cx)),
                        data_format=IMAGE_ORDERING)(o1)
    else:
        o2 = tf.keras.layers.Cropping2D(cropping=((0, 0),  (0, cx)),
                        data_format=IMAGE_ORDERING)(o2)

    if output_height1 > output_height2:
        o1 = tf.keras.layers.Cropping2D(cropping=((0, cy),  (0, 0)),
                        data_format=IMAGE_ORDERING)(o1)
    else:
        o2 = tf.keras.layers.Cropping2D(cropping=((0, cy),  (0, 0)),
                        data_format=IMAGE_ORDERING)(o2)
...
def fcn_8(n_classes, encoder=vanilla_encoder, input_height=416,
    ...
    o = (tf.keras.layers.Conv2D(4096, (7, 7), activation='relu',
                padding='same', data_format=IMAGE_ORDERING))(o)
    o = tf.keras.layers.Dropout(0.5)(o)
    o = (tf.keras.layers.Conv2D(4096, (1, 1), activation='relu',
                padding='same', data_format=IMAGE_ORDERING))(o)
    o = tf.keras.layers.Dropout(0.5)(o)

    o = (tf.keras.layers.Conv2D(n_classes,  (1, 1), kernel_initializer='he_normal',
                data_format=IMAGE_ORDERING))(o)
    o = tf.keras.layers.Conv2DTranspose(n_classes, kernel_size=(4, 4),  strides=(
        2, 2), use_bias=False, data_format=IMAGE_ORDERING)(o)

    o2 = f4
    o2 = (tf.keras.layers.Conv2D(n_classes,  (1, 1), kernel_initializer='he_normal',
                 data_format=IMAGE_ORDERING))(o2)
    ...
    o = tf.keras.layers.Add( name="seg_feats" )([o2, o])

    o = tf.keras.layers.Conv2DTranspose(n_classes, kernel_size=(16, 16),  strides=(
        8, 8), use_bias=False, padding="same", data_format=IMAGE_ORDERING)(o)
...
def fcn_32(n_classes, encoder=vanilla_encoder, input_height=416,
    ...
    o = tf.keras.layers.Conv2DTranspose(n_classes, kernel_size=(64, 64),  strides=(
